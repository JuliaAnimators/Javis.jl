...
"""
JEllipse(cpt::Point, w::Real, h::Real; color ="black",action=:stroke) = (args...; cpt=cpt, w=w, h=h, color=color, action=action) -> _JEllipse(cpt, w, h, color, action)
...
"""
JEllipse(focus1::Point, focus2::Point, k::Real; color="black", action=:stroke, stepvalue=pi/100, vertices=false, reversepath=false) = (args...;focus1=focus1, focus2=focus2, color=color, action=action) -> _JEllipse(focus1, focus2, k, color, action, stepvalue, vertices, reversepath)
...
"""
JEllipse(focus1::Point, focus2::Point, pt::Point; color="black", action=:stroke, stepvalue=pi/100, vertices=false, reversepath=false) = (args...;focus1=focus1, focus2=focus2, color=color, action=action) -> _JEllipse(focus1, focus2, pt, color, action, stepvalue, vertices, reversepath)
